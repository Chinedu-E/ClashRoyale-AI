from keras.layers import (Input, Conv2D, Flatten, Dense, Conv2DTranspose, Reshape,
                        MaxPooling2D, Activation, BatchNormalization, LeakyReLU, Dropout, Layer, UpSampling2D)
...
class VariationalAutoencoder:
    ...
    def compile(self, learning_rate, r_loss_factor):
        ...
        self.model.compile(optimizer=optimizer, loss = vae_loss,  metrics = [vae_r_loss, vae_kl_loss, 'accuracy'], experimental_run_tf_function=False)
